        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm text-left border border-gray-300 rounded-md overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $customermemberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-purple-50 transition">
                            <td class="py-3 px-4 border text-gray-800"><?php echo e($index + 1); ?></td>
                            <td class="py-3 px-4 border font-medium text-gray-800"><?php echo e($member->name); ?></td>
                            <td class="py-3 px-4 border text-gray-700"><?php echo e($member->whatsapp); ?></td>
                            ...
                            <td class="py-3 px-4 border text-gray-700"><?php echo e($member->created_at->format('d M Y')); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASVS\Documents\PBL S5\fix\abee\resources\views/admin/membership/index.blade.php ENDPATH**/ ?>