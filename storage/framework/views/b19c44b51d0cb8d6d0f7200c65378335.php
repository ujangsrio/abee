    ...
    <div class="max-w-4xl mx-auto bg-white border border-purple-100 shadow-sm rounded-sm p-6">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" value="<?php echo e($customer->user->name ?? '-'); ?>" disabled
...
<?php echo $__env->make('customer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project Abee\abee\resources\views/customer/akun/index.blade.php ENDPATH**/ ?>