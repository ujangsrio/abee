            ...
            <table class="min-w-full bg-white rounded-md text-sm text-gray-800">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-purple-50 transition animate-fade-in-down delay-<?php echo e($index * 50); ?>">
                            <td class="py-3 px-4 font-medium"><?php echo e($booking->service->nama ?? '-'); ?></td>
                            <td class="py-3 px-4"><?php echo e(\Carbon\Carbon::parse($booking->date)->format('d M Y')); ?></td>
                            <td class="py-3 px-4"><?php echo e($booking->time); ?></td>
                            <td class="py-3 px-4 flex items-center gap-2">
                                ...
                                <span class="<?php echo e($statusClass); ?>"><?php echo e(ucfirst($booking->status)); ?></span>
                            </td>
                        </tr>
...
<?php echo $__env->make('customer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASVS\Documents\PBL S5\fix\abee\resources\views/customer/history/index.blade.php ENDPATH**/ ?>