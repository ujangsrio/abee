...
<body>
  ...
  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo e(asset('images/landingpage/landingpage.jpg')); ?>" class="d-block w-100" alt="Aretha Beauty Front Image">
      </div>
    </div>
  </div>
  ...
  <div class="service-section text-center fade-in-section" id="services">
    <div class="container">
      ...
      <div class="row g-4">
        <?php $__currentLoopData = ['nail', 'makeup', 'henna', 'lashlift']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-3">
          <div class="card service-card h-100 shadow-sm">
            <img src="<?php echo e(asset("images/landingpage/$layanan.jpg")); ?>" class="card-img-top" alt="<?php echo e(ucfirst($layanan)); ?>">
            <div class="card-body">
              <h5 class="card-title"><?php echo e(ucfirst($layanan === 'nail' ? 'Nail Art' : ($layanan === 'lashlift' ? 'Lash Lift' : $layanan))); ?></h5>
              <p class="card-text">
                <?php switch($layanan):
                  case ('nail'): ?> Desain kuku yang indah dan kreatif. <?php break; ?>
                  <?php case ('makeup'): ?> Riasan profesional untuk acara spesial. <?php break; ?>
                  <?php case ('henna'): ?> Lukisan henna elegan untuk acara adat. <?php break; ?>
                  <?php case ('lashlift'): ?> Bulu mata lentik alami dan tahan lama. <?php break; ?>
                <?php endswitch; ?>
              </p>
            </div>
          </div>
...
<?php /**PATH C:\Users\ASVS\Documents\PBL S5\fix\abee\resources\views/landingpage.blade.php ENDPATH**/ ?>